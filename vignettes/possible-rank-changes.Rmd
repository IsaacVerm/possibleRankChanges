...
```{r}
possible_gameweek_points <- create_possible_gameweek_points(8)
```

Each row of the possible gameweek points is the home points column of a possible league outcome.
